...
if (isset($_POST['reg_user'])) {
  ...
  if ($password_1 != $password_2) {
   ...
   if (empty($dob)) { array_push($errors, "Date of Birth is required"); }
     if (empty($dob1)) { array_push($errors, "Age is required"); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO Citizen(Citizen_id, Password,Name,DOB,Age,Parents_name,Qualification,Address,image) 
  			  VALUES('$Citizen_id', '$password_1','$username','$dob','$dob1','$parent','$Qualification','$address','$imgContent')";
