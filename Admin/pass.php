...
$query=mysql_query("SELECT Password FROM administrator WHERE Username='".$user_2."' AND Password='".$pass_1."'");  
...
if($num>0)
{
mysql_query("UPDATE administrator SET Password='".$pass_2."' where Username='".$user_2."'");
