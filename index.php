    ...
    <nav class="navbar navbar-default hidden-xs">
        <div class="navbar-header">
            <a class="navbar-brand" href="">
                <img id="navbar-op-logo" style="width:140px" src="images/logo.jpg">
            </a>
        </div>
        <ul class="nav navbar-nav">
            ...
            <li>
                <a href="mailto:avinashyadav06.ay@gmail.com" class="contact_nav_link_class" onclick="trackSocialLink('Support Email', 'mailto:avinashyadav06.ay@gmail.com', false)">Contact Us</a>
            </li>
        </ul>
    </nav>
    <br><br>
        ...
        <div class="row main-row">
            ...
            <div class="col-xs-12 col-sm-6" id=greetingContainer>
                <div class="greeting col-xs-12 col-lg-10">
                    ...
                    <h4>Looking for something? Make a request and we'll find it for you.</h4>
                </div>
            </div>
   ...
   <!-- Footer -->
    <footer class="footer">
            <div class="footer-header">
                ...
                <div class="all-rights hidden-sm">&#xa9;&nbsp;2018 All Rights Reserved</div>
            </div>
            <div class="footer-links">
                <ul>
                    <li><a href=""></a></li>
                    <li><a href=""></a></li>
                    <li><a href="mailto:avinashyadav06.ay@gmail.com" onclick="trackSocialLink('Support Email', 'mailto:avinashyadav06.ay@gmail.com', false)">Contact us</a></li>
                   
                    <li><a href="https://twitter.com/avinash___yadav" onclick="trackSocialLink('Twitter', 'https://twitter.com/avinash___yadav')"><img id="img_twitter"></a></li>
                    <li><a href="https://www.facebook.com/sprindigobook/" onclick="trackSocialLink('Facebook', 'https://www.facebook.com/sprindigobook/')"><img id="img_facebook"></a></li>
                </ul>
            </div>
    </footer>
