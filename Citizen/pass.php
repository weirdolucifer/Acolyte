...
$query=mysql_query("SELECT Password FROM Citizen WHERE Citizen_id='".$user_2."' AND Password='".$pass_1."'");  
...
if($num>0)
{
mysql_query("UPDATE Citizen SET Password='".$pass_2."' where Citizen_id='".$user_2."'");
