        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="profile.php#FIR1">
                  <span data-feather="file-text"></span>
                  e-FIR
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="profile.php#FIR2">
                  <span data-feather="file"></span>
                  View FIR
                </a>
              </li>
               <li class="nav-item">
                <a class="nav-link" href="profile.php#Licence">
                  <span data-feather="folder-plus"></span>
                  Apply for Licence
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="profile.php#Licence1">
                  <span data-feather="folder-plus"></span>
                  View Licences
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="profile.php#PS">
            ...
            <ul class="nav flex-column mb-2">
              <li class="nav-item">
                <a class="nav-link" href="profile.php#Aadhar">
                  <span data-feather="file-text"></span>
                  Aadhar 
                </a>
              </li>
