...
$query=mysql_query("SELECT Password FROM magistrate WHERE Name='".$user_2."' AND Password='".$pass_1."'");  
...
if($num>0)
{
mysql_query("UPDATE magistrate SET Password='".$pass_2."' where Name='".$user_2."'");
